...
!$omp& private(coef,DETJ,X1,X2,X3,X4,X5,X6,X7,X8)                       &
!$omp& private(Y1,Y2,Y3,Y4,Y5,Y6,Y7,Y8)                                 &
!$omp& private(Z1,Z2,Z3,Z4,Z5,Z6,Z7,Z8)                                 &
!$omp& private(dZdT,dZdQ,dYdQ,dXdQ,dYdT,dXdT,dZdE,dYdE,dXdE)            &
!$omp& private(a13,a21,a22,a23,a31,a32,a33)            
...
!$omp& private(ie,je,ipn,jpn,kpn)                                       &
!$omp& private(PNXi,PNYi,PNZi,PNXj,PNYj,PNZj,a11,a12)                   &
!$omp& private(a13,a21,a22,a23,a31,a32,a33,coef)            
      do icel0=ELMCOLORindex(icol-1)+1,ELMCOLORindex(icol) 
...
!$omp target teams distribute parallel do collapse(3)                   &
!$omp& private(ie,je,ip,jp,kk,iiS,iiE,iDlu,k)      
      do icel0=ELMCOLORindex(icol-1)+1,ELMCOLORindex(icol)
!C
!C== CONSTRUCT the GLOBAL MATRIX
         do ie=1,8
